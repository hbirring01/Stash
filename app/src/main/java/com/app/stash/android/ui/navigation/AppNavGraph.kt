package com.app.stash.android.ui.navigation
...
import com.app.stash.android.ui.add.AddCardScreen
import com.app.stash.android.ui.home.HomeScreen
import com.app.stash.android.ui.plaidsetup.PlaidSetupScreen
import com.app.stash.android.ui.transactions.TransactionsScreen
...
fun AppNavGraph() {
    ...
    NavHost(
        ...
        composable(Destination.RewardsHub.route) {
            com.app.stash.android.ui.rewards.hub.RewardsHubScreen(
                onBack = { navController.popBackStack() }
            )
        }
        composable(Destination.Offers.route) {
            com.app.stash.android.ui.offers.OffersScreen(
                onBack = { navController.popBackStack() }
            )
        }
        composable(
