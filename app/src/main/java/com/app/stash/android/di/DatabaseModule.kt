    ...
    private object DebugSeed : RoomDatabase.Callback() {
        override fun onCreate(db: SupportSQLiteDatabase) {
            ...
            val balSql = """
                ...
                VALUES (?, ?, ?, ?, ?)
            """.trimIndent()
            db.execSQL(balSql, arrayOf<Any?>(1L, "Chase Ultimate Rewards", 84_500.0, 1.5, now))
            db.execSQL(balSql, arrayOf<Any?>(3L, "Amex Membership Rewards", 142_300.0, 1.5, now))
            ...
            db.execSQL(rotSql, arrayOf<Any?>(2L, "GAS", 5.0, q2Start, q2End, "Q2 2026 — Gas & Streaming"))
            ...
            val offers = listOf(
                arrayOf<Any?>("starbucks", "Starbucks", "Chase", null, "PERCENT", 10.0, 5.0, 0.0, plus30d, null, "CURATED", chaseUri, "10% back on Starbucks purchases"),
                arrayOf<Any?>("target", "Target", "Amex", null, "PERCENT", 8.0, 25.0, 0.0, plus30d, null, "CURATED", amexUri, "8% back at Target"),
                arrayOf<Any?>("walmart", "Walmart", "Citi", null, "PERCENT", 5.0, 15.0, 25.0, plus30d, null, "CURATED", citiUri, "5% back on $25+ at Walmart"),
                arrayOf<Any?>("whole foods", "Whole Foods", "Amex", null, "FLAT", 10.0, null, 50.0, plus30d, null, "CURATED", amexUri, "$10 back on $50+ at Whole Foods"),
                arrayOf<Any?>("home depot", "The Home Depot", "Chase", null, "PERCENT", 6.0, 30.0, 0.0, plus30d, null, "CURATED", chaseUri, "6% back at Home Depot"),
                arrayOf<Any?>("uber", "Uber", "Amex", null, "PERCENT", 12.0, 10.0, 0.0, plus30d, null, "CURATED", amexUri, "12% back on Uber rides"),
                arrayOf<Any?>("doordash", "DoorDash", "Chase", null, "PERCENT", 10.0, 8.0, 0.0, plus30d, null, "CURATED", chaseUri, "10% back on DoorDash"),
                arrayOf<Any?>("best buy", "Best Buy", "Citi", null, "FLAT", 20.0, null, 100.0, plus30d, null, "CURATED", citiUri, "$20 back on $100+ at Best Buy"),
                arrayOf<Any?>("cvs", "CVS Pharmacy", "Discover", null, "PERCENT", 5.0, 10.0, 0.0, plus30d, null, "CURATED", discoverUri, "5% back at CVS"),
                arrayOf<Any?>("shell", "Shell", "Chase", null, "POINTS_MULT", 3.0, null, 0.0, plus30d, null, "CURATED", chaseUri, "3× points at Shell gas stations"),
            )
            ...
            val sampleCredits = listOf(
                arrayOf<Any?>(1L, "Travel Credit", 300.0, "ANNUAL", 1, 1, "TRAVEL", "Auto-applies to any travel charge", "CURATED", null, "TRAVEL", 1, now),
                arrayOf<Any?>(3L, "Hotel Credit", 200.0, "ANNUAL", 1, 1, "TRAVEL", "Fine Hotels + Resorts and The Hotel Collection", "CURATED", "marriott|hilton|hyatt|ihg|four seasons", "TRAVEL", 1, now),
                arrayOf<Any?>(3L, "Uber Cash", 200.0, "ANNUAL", 1, 1, "RIDESHARE", "Monthly $15 / December $35 Uber Cash", "CURATED", "uber", null, 1, now),
                arrayOf<Any?>(3L, "Airline Incidental", 200.0, "ANNUAL", 1, 1, "TRAVEL", "Select one airline at start of year", "CURATED", "delta|american airlines|united|southwest|jetblue", "TRAVEL", 1, now),
                arrayOf<Any?>(3L, "Digital Entertainment", 240.0, "ANNUAL", 1, 1, "ENTERTAINMENT", "Disney+ / Hulu / NYT / WSJ etc.", "CURATED", "disney|hulu|nytimes|wall street journal|peacock|sirius", null, 1, now),
            )
